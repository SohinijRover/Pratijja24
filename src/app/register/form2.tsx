      ...
      {({ isSubmitting, values, handleChange }) => (
        <Form>
          <div className="flex flex-col items-center justify-center ">
            ...
            {/* Number of Slots */}
            <div className="flex items-center justify-center bg-slate-300 rounded-lg text-black mt-4 pe-4">
                  ...
                  {[1, 2, 3, 4, 5].map((slot) => (
                    <label key={slot} htmlFor={`slot${slot}`}>
                      <input
                        ...
                        name="slots"
                        value={slot}
                        checked={Number(values.slots) === slot}
                  ...
                  {[1, 2, 3, 4, 5].map((ajudicator_slots) => (
                    <label key={ajudicator_slots} htmlFor={`ajudicatorSlot${ajudicator_slots}`}>
                      <input
                        ...
                        checked={Number(values.ajudicator_slots) === ajudicator_slots}
                        onChange={handleChange}
                      />
                      {ajudicator_slots}
                    </label>
            ...
            {/* Accommodation */}
            <div className="flex items-center justify-center bg-slate-300 rounded-lg text-black ps-2">
              <Box mb="10px">
                <FormControlLabel
                  control={
                    <Field
