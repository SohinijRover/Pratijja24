...
const PratijjaDropdown = () => {
    return (
        <div className=" transition-all duration-400 absolute px-4 text-center bg-black rounded-lg right-1/2 translate-x-1/2 py-2 mt-4 text-white hidden group-hover:block ease-in-out">
