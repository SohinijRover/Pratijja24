  ...
  return (
    <div className='aboutPratijja'>
      ...
      <div className='p-4 md:p-12 pt-4 md:pt-8 text-base md:text-lg text-[#7972C2] text-justify' >
        ...
        comes from sections 1.10.32 and 1.10.33 of "de Finibus Bonorum Malorum" (The Extremes of Good and Evil) by
        ...
        accompanied by English versions from the 1914 translation by H. Rackham. Contrary to popular belief, Lorem
        ...
        1.10.33 of "de Finibus Bonorum Malorum" (The Extremes of Good and Evil) by Cicero, written in 45 BC. This book
        is a treatise on the theory of ethics, very popular during the Renaissance. The first line of Lorem Ipsum,
        "Lorem ipsum dolor sit amet..", comes from a line in section 1.10.32. The standard chunk of Lorem Ipsum used
        since the 1500s is reproduced below for those interested. Sections 1.10.32 and 1.10.33 from "de Finibus Bonorum
        et Malorum" by Cicero are also reproduced in their exact original form, accompanied by English versions from the
