...
const Hero = () => {
  return (
    <>
      <div className="h-screen font-sans flex flex-col md:flex-row items-center justify-center bg-gradient-to-t from-page-purple from-0% to-transparent to-20% max-h-[100vh] mt-14">
