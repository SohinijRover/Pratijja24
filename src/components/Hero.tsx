...
const Hero = () => {
  return (
    <>
    <div className="relative font-sans" style={{
        backgroundImage: "linear-gradient(180deg, #000000, #000000)"
      }}>
        <div className="top-1/2 left-70 transform -translate-y-1/2 text-white absolute text-2xl p-5 grid place-items-center place-content-center">  
        ...
        <div className="absolute h-screen w-full flex items-center justify-center border border-red-500">
